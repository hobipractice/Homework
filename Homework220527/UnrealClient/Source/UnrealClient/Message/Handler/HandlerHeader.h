...
{														
	...
	Dis.AddHandler(MessageId::MonsterDamaged, std::bind(&OnMessageProcess<ThreadHandlerMonsterDamagedMessage, MonsterDamagedMessage>, std::placeholders::_1, Inst, World));	
