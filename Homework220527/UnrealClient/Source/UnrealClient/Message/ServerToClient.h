...
class MonsterDamagedMessage : public GameServerMessage                    
{                                                               
public:                                                         
	uint64_t AttObjectIndex;
	uint64_t DmgObjectIndex;
	uint64_t DamagedValue;
                                                                
public:                                                         
    MonsterDamagedMessage()                                               
        : GameServerMessage(static_cast<uint32_t>(MessageId::MonsterDamaged))                    
        , AttObjectIndex()
        , DmgObjectIndex()
        , DamagedValue()
    {                                                           
    ...
    virtual ~MonsterDamagedMessage() {}                                   
                                                                
    virtual int SizeCheck()                                     
    {                                                           
		return DataSizeCheck(AttObjectIndex) + DataSizeCheck(DmgObjectIndex) + DataSizeCheck(DamagedValue);
    }                                                           
                                                                
    void Serialize(GameServerSerializer& _Serializer)           
    {                                                           
        GameServerMessage::Serialize(_Serializer);              
        _Serializer << AttObjectIndex;
        _Serializer << DmgObjectIndex;
        _Serializer << DamagedValue;
