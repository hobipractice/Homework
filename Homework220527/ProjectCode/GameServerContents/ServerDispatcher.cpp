...
{																																													
	...
	Dis.AddHandler(static_cast<uint32_t>(MessageId::PlayerAttack), std::bind(&OnMessageProcess<ThreadHandlerPlayerAttackMessage, PlayerAttackMessage>, std::placeholders::_1, std::placeholders::_2));	
