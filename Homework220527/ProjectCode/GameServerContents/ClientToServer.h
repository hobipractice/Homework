...
class PlayerAttackMessage : public GameServerMessage                    
{                                                               
public:                                                         
	FPlayerUpdateData Datas;
	uint64_t DurationTimeMs;
                                                                
public:                                                         
    PlayerAttackMessage()                                               
        : GameServerMessage(static_cast<uint32_t>(MessageId::PlayerAttack))                    
        , Datas()
        , DurationTimeMs()
    {                                                           
    ...
    virtual ~PlayerAttackMessage() {}                                   
                                                                
    virtual int SizeCheck()                                     
    {                                                           
		return DataSizeCheck(Datas) + DataSizeCheck(DurationTimeMs);
    }                                                           
                                                                
    void Serialize(GameServerSerializer& _Serializer)           
    {                                                           
        GameServerMessage::Serialize(_Serializer);              
        Datas.Serialize(_Serializer);
        _Serializer << DurationTimeMs;
